...
public class NearestHospitalsActivity extends AppCompatActivity {
    Spinner spType;
    Button btFind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(NearestHospitalsActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) ==
            ...
            ActivityCompat.requestPermissions(NearestHospitalsActivity.this,
        ...
        btFind.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json" + "?location=" + currentLat + "," + currentLong
                        +"&radius=5000"+"&types="+placeTypeList[i] + "&sensor=true"+"&key=" +getResources().getString(R.string.google_map_key);
