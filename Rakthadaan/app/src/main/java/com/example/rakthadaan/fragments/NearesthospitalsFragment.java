...
public class NearesthospitalsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_nearesthospitals, container, false);
...
//        search = et.getText().toString();
       ...
       // webView.getSettings().setGeolocationDatabasePath(getFilesDir().getPath());
        ...
        webView.loadUrl("https://www.google.com/maps/search/Hospitals/@15.9128998,79.7399875,6z");
        return v;
    }
        ...
        switch (requestCode) {
            case REQUEST_CODE_ASK_MULTIPLE_PERMISSIONS: {
                ...
                if (perms.get(Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED
                    ...
                    // Permission Denied
                    Toast.makeText(getContext(), "All Permission GRANTED !! Thank You :)", Toast.LENGTH_SHORT)
                            .show();
